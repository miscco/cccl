...
template <class Iter>
inline constexpr bool HasForEachN<Iter, cuda::std::void_t<decltype(cuda::std::ranges::for_each_n(cuda::std::declval<Iter>(), 0, Callable{}))>> = true;
...
template <class Func>
inline constexpr bool HasForEachItFunc<Func, cuda::std::void_t<decltype(cuda::std::ranges::for_each_n(static_cast<int*>(nullptr), 0, cuda::std::declval<Func>()))>> = true;
