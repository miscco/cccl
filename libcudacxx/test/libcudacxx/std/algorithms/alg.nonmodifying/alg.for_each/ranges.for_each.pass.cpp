...
inline constexpr bool HasForEachIt<Iter, Sent, cuda::std::void_t<decltype(cuda::std::ranges::for_each(cuda::std::declval<Iter>(), cuda::std::declval<Sent>(), Callable{}))>> = true;
...
template <class Func>
inline constexpr bool HasForEachItFunc<Func, cuda::std::void_t<decltype(cuda::std::ranges::for_each(static_cast<int*>(nullptr), static_cast<int*>(nullptr), cuda::std::declval<Func>()))>> = true;
...
inline constexpr bool HasForEachR<Range, cuda::std::void_t<decltype(cuda::std::ranges::for_each(cuda::std::declval<Range>(), Callable{}))>> = true;
...
template <class Func>
inline constexpr bool HasForEachRFunc<Func, cuda::std::void_t<decltype(cuda::std::ranges::for_each(cuda::std::declval<UncheckedRange<int*>>(), cuda::std::declval<Func>()))>> = true;
