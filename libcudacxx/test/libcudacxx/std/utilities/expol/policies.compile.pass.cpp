...
static_assert(
    cuda::std::is_same<remove_cvref_t<decltype(cuda::std::execution::seq)>,
                       cuda::std::execution::sequenced_policy>::value,
    "");
static_assert(
    cuda::std::is_same<remove_cvref_t<decltype(cuda::std::execution::par_host)>,
                       cuda::std::execution::parallel_policy_host>::value,
    "");
static_assert(
    cuda::std::is_same<remove_cvref_t<decltype(cuda::std::execution::par_device)>,
                       cuda::std::execution::parallel_policy_device>::value,
    "");
static_assert(cuda::std::is_same<
                  remove_cvref_t<decltype(cuda::std::execution::par_unseq_host)>,
                  cuda::std::execution::parallel_unsequenced_policy_host>::value,
              "");
static_assert(cuda::std::is_same<
                  remove_cvref_t<decltype(cuda::std::execution::par_unseq_device)>,
                  cuda::std::execution::parallel_unsequenced_policy_device>::value,
              "");
static_assert(
    cuda::std::is_same<remove_cvref_t<decltype(cuda::std::execution::unseq_host)>,
                       cuda::std::execution::unsequenced_policy_host>::value,
    "");
static_assert(
    cuda::std::is_same<remove_cvref_t<decltype(cuda::std::execution::unseq_device)>,
