...
_LIBCUDACXX_CONCEPT_FRAGMENT(check_mdspan_ctor_implicit_, requires(MDS m, Args... args)((m = {args...})));

template <class MDS, class... Args>
_LIBCUDACXX_CONCEPT check_mdspan_ctor_implicit = _LIBCUDACXX_FRAGMENT(check_mdspan_ctor_implicit_, MDS, Args...);
