...
_LIBCUDACXX_CONCEPT_FRAGMENT(check_mdspan_ctor_implicit_,
                             requires(MDS m, typename MDS::data_handle_type h, const Exts& exts)((m = {h, exts})));

template <class MDS, class Exts>
_LIBCUDACXX_CONCEPT check_mdspan_ctor_implicit = _LIBCUDACXX_FRAGMENT(check_mdspan_ctor_implicit_, MDS, Exts);
