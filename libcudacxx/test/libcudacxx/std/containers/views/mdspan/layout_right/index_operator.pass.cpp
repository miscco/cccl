...
template <class Mapping, class... Indices>
_LIBCUDACXX_CONCEPT operator_constraints = _LIBCUDACXX_FRAGMENT(operator_constraints_, Mapping, Indices...);

_LIBCUDACXX_TEMPLATE(class Mapping, class... Indices)
_LIBCUDACXX_REQUIRES(operator_constraints<Mapping, Indices...>)
