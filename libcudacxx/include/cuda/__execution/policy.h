...
{
  ::cuda::mr::any_resource<::cuda::mr::device_accessible> __resource_;
...
private:
  ...
  _CCCL_TEMPLATE(class _Resource,
                 ...
                 bool _WithResource = __cuda_policy_with_memory_resource<_Policy>)
  _CCCL_REQUIRES((!_WithStream) _CCCL_AND _WithResource)
  _CCCL_HOST_API constexpr __execution_policy_base(_Resource&& __resource) noexcept
      : __stream_holder()
  ...
  _CCCL_TEMPLATE(class _Resource,
                 ...
                 bool _WithResource = __cuda_policy_with_memory_resource<_Policy>)
  _CCCL_REQUIRES(_WithStream _CCCL_AND _WithResource)
  _CCCL_HOST_API constexpr __execution_policy_base(::cuda::stream_ref __stream, _Resource&& __resource) noexcept
      : __stream_holder(__stream)
      , __resource_holder(::cuda::std::forward<_Resource>(__resource))
  {}
...
public:
  ...
  //! @brief Convert to a policy that holds a stream, lvalue reference
  _CCCL_TEMPLATE(bool _WithStream   = __cuda_policy_with_stream<_Policy>,
                 bool _WithResource = __cuda_policy_with_memory_resource<_Policy>)
  _CCCL_REQUIRES((!_WithStream) _CCCL_AND _WithResource)
  [[nodiscard]] _CCCL_HOST_API auto set_stream(::cuda::stream_ref __stream) & noexcept
  {
    constexpr uint32_t __new_policy = __set_cuda_backend_option<_Policy, __cuda_backend_options::__with_stream>;
    return __execution_policy_base<__new_policy>{__stream, this->__resource_};
  }

  //! @brief Convert to a policy that holds a stream, rvalue reference
  _CCCL_TEMPLATE(bool _WithStream   = __cuda_policy_with_stream<_Policy>,
                 bool _WithResource = __cuda_policy_with_memory_resource<_Policy>)
  _CCCL_REQUIRES((!_WithStream) _CCCL_AND _WithResource)
  [[nodiscard]] _CCCL_HOST_API auto set_stream(::cuda::stream_ref __stream) && noexcept
  {
    constexpr uint32_t __new_policy = __set_cuda_backend_option<_Policy, __cuda_backend_options::__with_stream>;
    return __execution_policy_base<__new_policy>{__stream, ::cuda::std::move(this->__resource_)};
  }
  ...
  [[nodiscard]] _CCCL_HOST_API auto set_memory_resource(_Resource&& __resource) const noexcept
  {
    ...
    {
      return __execution_policy_base<__new_policy>{this->__stream_, ::cuda::std::forward<_Resource>(__resource)};
    }
    else
    {
      return __execution_policy_base<__new_policy>{::cuda::std::forward<_Resource>(__resource)};
    }
  }
  ...
  {
    this->__resource_ = ::cuda::std::forward<_Resource>(__resource);
    return *this;
  }
