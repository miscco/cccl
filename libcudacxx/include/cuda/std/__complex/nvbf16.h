...
{
template <>
struct __is_implicitly_convertible<__nv_bfloat16, float>
{
  static constexpr bool value = true;
};

template <>
struct __is_implicitly_convertible<__nv_bfloat16, double>
{
  static constexpr bool value = true;
};

template <>
struct __is_implicitly_convertible<float, __nv_bfloat16>
{
  static constexpr bool value = true;
};

template <>
struct __is_implicitly_convertible<double, __nv_bfloat16>
{
  static constexpr bool value = true;
};
} // namespace __cccl_internal
...
public:
  ...
  template <class _Up, __enable_if_t<__cccl_internal::__is_implicitly_convertible<value_type, _Up>::value, int> = 0>
  ...
  template <class _Up,
            __enable_if_t<!__cccl_internal::__is_implicitly_convertible<value_type, _Up>::value, int> = 0,
