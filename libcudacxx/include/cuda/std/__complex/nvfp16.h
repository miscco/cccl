...
{
template <>
struct __is_implicitly_convertible<__half, float>
{
  static constexpr bool value = true;
};

template <>
struct __is_implicitly_convertible<__half, double>
{
  static constexpr bool value = true;
};

template <>
struct __is_implicitly_convertible<float, __half>
{
  static constexpr bool value = true;
};

template <>
struct __is_implicitly_convertible<double, __half>
{
  static constexpr bool value = true;
};
} // namespace __cccl_internal
