...
struct _CCCL_TYPE_VISIBILITY_DEFAULT pair : public __pair_base<_T1, _T2>
{
  ...
  template <class _U1                         = _T1,
            class _U2                         = _T2,
            __select_constructor _Constraints = _VariadicConstraints<_U1, _U2>,
            enable_if_t<_ConstructorConstraint<_Constraints>::__can_construct_implicitly, int> = 0>
  ...
  template <class _UPair>
  static constexpr __select_constructor __pair_like_constructible =
    __pair_constraints<_T1, _T2>::template __select_pair_like_constructible<_UPair>();

  // converting constructors
  template <class _U1,
            class _U2,
            __select_constructor _Constraints = __pair_like_constructible<pair<_U1, _U2>&>,
            enable_if_t<_ConstructorConstraint<_Constraints>::__can_construct_implicitly, int> = 0>
  ...
  template <class _U1,
            class _U2,
            __select_constructor _Constraints = __pair_like_constructible<const pair<_U1, _U2>&>,
            enable_if_t<_ConstructorConstraint<_Constraints>::__can_construct_implicitly, int> = 0>
  ...
  template <class _UPair,
            ...
            __select_constructor _Constraints                          = __pair_like_constructible<_UPair>,
            enable_if_t<_ConstructorConstraint<_Constraints>::__can_construct_implicitly, int> = 0>
  ...
  template <bool _IsConst, class _UPair>
  static constexpr bool __pair_like_assignable =
    __pair_constraints<_T1, _T2>::template __select_pair_like_assignable<_IsConst, _UPair>();
  ...
  _CCCL_EXEC_CHECK_DISABLE
  template <class _UPair,
            bool _CanAssign              = __pair_like_assignable</*__is_const=*/false, _UPair>,
  ...
  _CCCL_EXEC_CHECK_DISABLE
  template <class _UPair,
            bool _CanAssign              = __pair_like_assignable</*__is_const=*/true, _UPair>,
            enable_if_t<_CanAssign, int> = 0>
