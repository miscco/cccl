...
template <class _Tp>
_LIBCUDACXX_CONCEPT __tuple_like = __tuple_like_impl<__remove_cvref_t<_Tp>>::value;

template <class _Tp>
_LIBCUDACXX_CONCEPT __pair_like =
  __tuple_like_impl<__remove_cvref_t<_Tp>>::value && (tuple_size<__remove_cvref_t<_Tp>>::value == 2);
