...
template <class>
_LIBCUDACXX_INLINE_VAR constexpr bool is_execution_policy_v = false;

template <>
_LIBCUDACXX_INLINE_VAR constexpr bool is_execution_policy_v<_CUDA_VEXEC::sequenced_policy> = true;

template <>
_LIBCUDACXX_INLINE_VAR constexpr bool is_execution_policy_v<_CUDA_VEXEC::parallel_policy_host> = true;

template <>
_LIBCUDACXX_INLINE_VAR constexpr bool is_execution_policy_v<_CUDA_VEXEC::parallel_policy_device> = true;

template <>
_LIBCUDACXX_INLINE_VAR constexpr bool is_execution_policy_v<_CUDA_VEXEC::parallel_unsequenced_policy_host> = true;

template <>
_LIBCUDACXX_INLINE_VAR constexpr bool is_execution_policy_v<_CUDA_VEXEC::parallel_unsequenced_policy_device> = true;

template <>
_LIBCUDACXX_INLINE_VAR constexpr bool is_execution_policy_v<_CUDA_VEXEC::unsequenced_policy_host> = true;

template <>
_LIBCUDACXX_INLINE_VAR constexpr bool is_execution_policy_v<_CUDA_VEXEC::unsequenced_policy_device> = true;

template <class>
_LIBCUDACXX_INLINE_VAR constexpr bool __is_parallel_execution_policy_impl_v = false;

template <class _Tp>
_LIBCUDACXX_INLINE_VAR constexpr bool __is_parallel_execution_policy_v =
  __is_parallel_execution_policy_impl_v<__remove_cvref_t<_Tp>>;

template <>
_LIBCUDACXX_INLINE_VAR constexpr bool __is_parallel_execution_policy_impl_v<_CUDA_VEXEC::parallel_policy_host> = true;

template <>
_LIBCUDACXX_INLINE_VAR constexpr bool __is_parallel_execution_policy_impl_v<_CUDA_VEXEC::parallel_policy_device> = true;

template <>
_LIBCUDACXX_INLINE_VAR constexpr bool
  __is_parallel_execution_policy_impl_v<_CUDA_VEXEC::parallel_unsequenced_policy_host> = true;

template <>
_LIBCUDACXX_INLINE_VAR constexpr bool
  __is_parallel_execution_policy_impl_v<_CUDA_VEXEC::parallel_unsequenced_policy_device> = true;

template <class>
_LIBCUDACXX_INLINE_VAR constexpr bool __is_unsequenced_execution_policy_impl_v = false;

template <class _Tp>
_LIBCUDACXX_INLINE_VAR constexpr bool __is_unsequenced_execution_policy_v =
  __is_unsequenced_execution_policy_impl_v<__remove_cvref_t<_Tp>>;

template <>
_LIBCUDACXX_INLINE_VAR constexpr bool
  __is_unsequenced_execution_policy_impl_v<_CUDA_VEXEC::parallel_unsequenced_policy_host> = true;
...
template <>
_LIBCUDACXX_INLINE_VAR constexpr bool __is_unsequenced_execution_policy_impl_v<_CUDA_VEXEC::unsequenced_policy_host> =
  true;

template <>
_LIBCUDACXX_INLINE_VAR constexpr bool __is_unsequenced_execution_policy_impl_v<_CUDA_VEXEC::unsequenced_policy_device> =
  true;
