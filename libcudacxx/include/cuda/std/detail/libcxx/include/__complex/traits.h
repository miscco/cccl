...
_LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 __abcd_results<_Tp>
...
template <class _Tp, typename = __enable_if_t<!__has_vector_type<_Tp>::value>>
_LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 __ab_results<_Tp>
