...
public:
  ...
  auto operator==(const __zip_iterator& __x, const __zip_iterator& __y)
    _LIBCUDACXX_TRAILING_REQUIRES(bool) _LIBCUDACXX_REQUIRES(__all_equality_comparable<_OtherConst>)
  {
  ...
  auto operator-(const __zip_iterator& __x, const __zip_iterator& __y) _LIBCUDACXX_TRAILING_REQUIRES(difference_type)
    _LIBCUDACXX_REQUIRES(__all_sized_sentinel<_OtherConst>)
  {
  ...
  auto iter_swap(const __zip_iterator& __l, const __zip_iterator& __r)
    ...
    _LIBCUDACXX_TRAILING_REQUIRES(void) _LIBCUDACXX_REQUIRES(__all_indirectly_swappable<_OtherConst>)
  {
...
public:
  ...
  auto operator==(const __iterator<_OtherConst>& __x, const __zip_sentinel& __y)
    _LIBCUDACXX_TRAILING_REQUIRES(bool) _LIBCUDACXX_REQUIRES(__all_sentinel<_OtherConst>)
  {
