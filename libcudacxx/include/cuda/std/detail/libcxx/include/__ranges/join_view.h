...
private:
  ...
  public:
    ...
    _LIBCUDACXX_TEMPLATE(bool _OtherConst = _Const)
      _LIBCUDACXX_REQUIRES(_OtherConst _LIBCUDACXX_AND
    ...
    _LIBCUDACXX_TEMPLATE(bool __ref_is_glvalue2 = __ref_is_glvalue)
      _LIBCUDACXX_REQUIRES(__ref_is_glvalue2 _LIBCUDACXX_AND
    ...
    _LIBCUDACXX_TRAILING_REQUIRES(bool)(__ref_is_glvalue2 &&
