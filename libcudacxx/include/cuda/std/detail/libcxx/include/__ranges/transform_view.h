...
public:
  ...
  public:
    ...
    friend constexpr auto operator==(const __iterator<_OtherConst>& __x, const __sentinel& __y)
      _LIBCUDACXX_TRAILING_REQUIRES(bool)
        _LIBCUDACXX_REQUIRES(sentinel_for<sentinel_t<_Base>, iterator_t<__maybe_const<_OtherConst, _View>>>) {
    ...
    friend constexpr auto operator-(const __iterator<_OtherConst>& __x, const __sentinel& __y)
      _LIBCUDACXX_TRAILING_REQUIRES(range_difference_t<__maybe_const<_OtherConst, _View>>)
        _LIBCUDACXX_REQUIRES(sized_sentinel_for<sentinel_t<_Base>, iterator_t<__maybe_const<_OtherConst, _View>>>) {
      return __x.__current_ - __y.__end_;
    }
  ...
  _LIBCUDACXX_TEMPLATE(class _View2 = _View)
    _LIBCUDACXX_REQUIRES(range<const _View2> _LIBCUDACXX_AND
  ...
  _LIBCUDACXX_TEMPLATE(class _View2 = _View)
    _LIBCUDACXX_REQUIRES((range<const _View2> && !common_range<const _View2>) _LIBCUDACXX_AND
             __regular_invocable_with_range_ref<const _Fn&, const _View2>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  ...
  _LIBCUDACXX_TEMPLATE(class _View2 = _View)
    _LIBCUDACXX_REQUIRES(common_range<const _View2> _LIBCUDACXX_AND
             __regular_invocable_with_range_ref<const _Fn&, const _View2>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
