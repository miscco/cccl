...
struct __cb_copy_base<_Tp, false> : __cb_destruct_base<_Tp> {
  ...
  __cb_copy_base() noexcept = default;
  ...
  __cb_copy_base(__cb_copy_base&&) = default;
  __cb_copy_base& operator=(const __cb_copy_base&) = default;
  __cb_copy_base& operator=(__cb_copy_base&&) = default;
};
...
struct __cb_move_base<_Tp, false> : __cb_copy_base<_Tp> {
  ...
  __cb_move_base() noexcept = default;
  __cb_move_base(const __cb_move_base&) = default;
  ...
  __cb_move_base& operator=(const __cb_move_base&) = default;
  __cb_move_base& operator=(__cb_move_base&&) = default;
};
...
struct __cb_copy_assign_base<_Tp, false, true> : __cb_copy_base<_Tp> {
  ...
  __cb_copy_assign_base() noexcept = default;
  __cb_copy_assign_base(const __cb_copy_assign_base&) = default;
  __cb_copy_assign_base(__cb_copy_assign_base&&) = default;
  ...
  __cb_copy_assign_base& operator=(__cb_copy_assign_base&&) = default;
};
...
struct __cb_move_assign_base<_Tp, false, true> : __cb_copy_assign_base<_Tp> {
  ...
  __cb_move_assign_base() noexcept = default;
  __cb_move_assign_base(const __cb_move_assign_base&) = default;
  __cb_move_assign_base(__cb_move_assign_base&&) = default;

  __cb_move_assign_base& operator=(const __cb_move_assign_base&) = default;
...
struct __cb_copy_assign_base_simple {
  ...
  __cb_copy_assign_base_simple() = default;
...
struct __cb_copy_assign_base_simple<_Tp, false> {
  ...
  __cb_copy_assign_base_simple(const __cb_copy_assign_base_simple&) = default;
  __cb_copy_assign_base_simple(__cb_copy_assign_base_simple&&) = default;
  ...
  __cb_copy_assign_base_simple& operator=(__cb_copy_assign_base_simple&&) = default;
};
...
struct __cb_move_assign_base_simple<_Tp, false> : public __cb_copy_assign_base_simple<_Tp> {
  ...
  __cb_move_assign_base_simple() = default;
  __cb_move_assign_base_simple(const __cb_move_assign_base_simple&) = default;
  __cb_move_assign_base_simple(__cb_move_assign_base_simple&&) = default;

  __cb_move_assign_base_simple& operator=(const __cb_move_assign_base_simple&) = default;
