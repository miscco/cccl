...
_LIBCUDACXX_INLINE_VISIBILITY _Iterator __simd_walk(_Iterator __first, _DifferenceType __n, _Function __f) noexcept
{
  _CCCL_PRAGMA_SIMD
...
_LIBCUDACXX_INLINE_VISIBILITY __pstl_optional<__empty>
...
_LIBCUDACXX_INLINE_VISIBILITY __pstl_optional<_CUDA_VRANGES::in_fun_result<_Iter, _Func>>
