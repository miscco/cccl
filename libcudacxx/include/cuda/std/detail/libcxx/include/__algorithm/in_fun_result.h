...
struct in_fun_result {
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr operator in_fun_result<_InIter2, _Func2>() const& {
    return {in, fun};
  }

  _LIBCUDACXX_TEMPLATE(class _InIter2, class _Func2)
  _LIBCUDACXX_REQUIRES(convertible_to<_InIter1, _InIter2> _LIBCUDACXX_AND convertible_to<_Func1, _Func2>)
  _LIBCUDACXX_INLINE_VISIBILITY constexpr operator in_fun_result<_InIter2, _Func2>() && {
