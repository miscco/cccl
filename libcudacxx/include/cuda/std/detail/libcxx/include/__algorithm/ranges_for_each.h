...
private:
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr static for_each_result<_Iter, _Func>
...
public:
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr for_each_result<_Iter, _Func>
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr for_each_result<borrowed_iterator_t<_Range>, _Func>
...
{
_LIBCUDACXX_CPO_ACCESSIBILITY auto for_each = __for_each::__fn{};
} // namespace __cpo
