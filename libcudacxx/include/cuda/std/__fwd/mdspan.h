...
#ifndef _LIBCUDACXX___MDSPAN_LAYOUTS_H
#define _LIBCUDACXX___MDSPAN_LAYOUTS_H
...
_LIBCUDACXX_INLINE_VAR constexpr bool __is_valid_layout_mapping = false;

template <class _Layout, class _Extents>
_LIBCUDACXX_INLINE_VAR constexpr bool
  __is_valid_layout_mapping<_Layout, _Extents, __void_t<typename _Layout::template mapping<_Extents>>> = true;
} // namespace __mdspan_detail
...
#endif // _LIBCUDACXX___MDSPAN_LAYOUTS_H
