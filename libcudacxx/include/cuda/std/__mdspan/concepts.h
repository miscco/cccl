...
template <class _Tp>
_LIBCUDACXX_INLINE_VAR constexpr bool __is_extents_v = __is_extents<_Tp>::value;
...
template <class _Mapping>
_LIBCUDACXX_CONCEPT __layout_mapping_req_type = _LIBCUDACXX_FRAGMENT(__layout_mapping_req_type_, _Mapping);
...
template <class _Mapping>
_LIBCUDACXX_CONCEPT __layout_mapping_req_types = _LIBCUDACXX_FRAGMENT(__layout_mapping_req_types_, _Mapping);
#  endif // _CCCL_STD_VER <= 2017
...
template <class _Mapping>
_LIBCUDACXX_CONCEPT __layout_mapping_alike_prop = _LIBCUDACXX_FRAGMENT(__layout_mapping_alike_prop_, _Mapping);
...
template <class _Mapping>
_LIBCUDACXX_CONCEPT __layout_mapping_alike = _LIBCUDACXX_FRAGMENT(__layout_mapping_alike_, _Mapping);
#  endif // _CCCL_STD_VER <= 2017
...
template <class _Tp, class _IndexType>
_LIBCUDACXX_CONCEPT __index_pair_like = _LIBCUDACXX_FRAGMENT(__index_pair_like_, _Tp, _IndexType);
...
template <class _Tp>
_LIBCUDACXX_CONCEPT __index_like =
