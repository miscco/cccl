...
concept CanInstantiate = requires {
  typename cuda::std::ranges::lazy_split_view<View, Pattern>;
};
...
namespace test1 {
  ...
  static_assert( cuda::std::ranges::forward_range<Pattern>);
  static_assert( cuda::std::ranges::view<View>);
  static_assert( cuda::std::ranges::view<Pattern>);
  static_assert( cuda::std::indirectly_comparable<
      cuda::std::ranges::iterator_t<View>, cuda::std::ranges::iterator_t<Pattern>, cuda::std::ranges::equal_to>);
...
namespace test3 {
  ...
  static_assert( cuda::std::input_or_output_iterator<AlmostInputIterator>);
  static_assert(!cuda::std::input_iterator<AlmostInputIterator>);

  struct NonInputView : cuda::std::ranges::view_base {
...
namespace test6 {
  ...
  struct Empty{};
  struct IntForwardView : cuda::std::ranges::view_base {
...
namespace test7 {
  ...
  static_assert(!cuda::std::ranges::forward_range<View>);
  static_assert( cuda::std::ranges::forward_range<Pattern>);
  LIBCPP_STATIC_ASSERT(!cuda::std::ranges::__tiny_range<Pattern>);
  static_assert( cuda::std::ranges::view<View>);
  static_assert( cuda::std::ranges::view<Pattern>);
  static_assert( cuda::std::indirectly_comparable<
      cuda::std::ranges::iterator_t<View>, cuda::std::ranges::iterator_t<Pattern>, cuda::std::ranges::equal_to>);
...
namespace test8 {
  ...
  struct AlmostTinyRange : cuda::std::ranges::view_base {
    int* begin() const;
    int* end() const;
