...
`changelog <../releases/changelog.md>`_.
...
section <../standard_api.md>`_, `Extended API
section <../extended_api.md>`_, and [release section] to find which
features require newer releases.
...
-  Pascall: SM 60, 61 and 62.
   ...
   -  Blocking synchronization facilities (e.g. most of the
      ...
      section <../extended_api/synchronization_primitives.md>`_ for
      details.
